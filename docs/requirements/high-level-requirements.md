...
- Operator/Scorer **identity capture** (login, initials or device pairing) to
  populate the event log's actor-identity field, which the MVP defaults to
  "unknown".
